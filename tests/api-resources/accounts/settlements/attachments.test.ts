...
describe('resource attachments', () => {
  test('retrieve', async () => {
    const responsePromise = client.accounts.settlements.attachments.retrieve(
      'xxxxxxxxx',
      'settlementid',
      'attachmentid',
    );
  ...
  test('retrieve: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      client.accounts.settlements.attachments.retrieve('xxxxxxxxx', 'settlementid', 'attachmentid', {
