...
export class SessionsProfiles extends APIResource {
  /**
   * Create a corresponding Checkout Session for an order placed in your system using
   * predefined session profile
   *
   * #### Session with Instabank
   *
   * Note that `items` is a required property when creating a session with Instabank
   * configured.
   *
   * scopes:
   *
   ...
   */
  create(
    params: SessionsProfileCreateParams,
    options?: Core.RequestOptions,
  ): Core.APIPromise<SessionsProfileCreateResponse> {
    const {
      include_session,
    ...
    return this._client.post('/sessions-profile', {
 ...
 */
export type PublishConfiguration = Array<PublishConfiguration.PublishConfigurationItem>;

export namespace PublishConfiguration {
  export interface PublishConfigurationItem {
    channel: 'sms' | 'push';
     ...
     *
     * **`skipped`** will used in case where publish cannot be sent given the
     * `session.customer`.
     */
...
export interface SessionsProfileCreateResponse {
  /**
  ...
  session?: SessionsProfileCreateResponse.Session;
...
export namespace SessionsProfileCreateResponse {
...
export interface SessionsProfileCreateParams {
  /**
   * Body param:
   */
  order: SessionsProfileCreateParams.Order;

  /**
   * Body param: configuration profile
   */
  profile_id: string;
   ...
   * Body param:
   */
  url: SessionsProfileCreateParams.URL;
   ...
   */
  checkboxes?: Array<SessionsProfileCreateParams.Checkbox>;

  /**
   * Body param: Override configuration for the profile.
   */
  configuration?: SessionsProfileCreateParams.Configuration;

  /**
   * Body param:
   */
  customer?: SessionsProfileCreateParams.Customer;
  ...
  /**
   * Body param: ### Present only for _Express Checkout_ sessions.
   *
   ...
   */
  express?: SessionsProfileCreateParams.Express;

  /**
   * Body param: Configure merchant information used in the checkout.
   */
  merchant?: SessionsProfileCreateParams.Merchant;

  /**
   * Body param: Additional metadata about the resource
   */
  metadata?: unknown;
...
export namespace SessionsProfileCreateParams {
...
export declare namespace SessionsProfiles {
  export {
